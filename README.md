[ ![Download](https://api.bintray.com/packages/tianxiaxinyong/maven/PYH5Bridge/images/download.svg?version=1.2.2) ](https://bintray.com/tianxiaxinyong/maven/PYH5Bridge/1.2.2/link)
...
```
dependencies {
    compile 'com.pycredit.h5sdk:h5bridge:x.x.x' //x.x.x为SDK版本号,如:1.2.2
}
```
